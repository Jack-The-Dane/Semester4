...
#
# Script generated by Vivado on Wed Mar 06 00:39:24 CET 2024
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L sim_clk_gen_v1_0_3 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot clock xil_defaultlib.clock xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim clock -key {Behavioral:sim_1:Functional:clock} -tclbatch cmd.tcl -protoinst "protoinst_files/clock.protoinst" -protoinst "protoinst_files/multiplexer_4_1.protoinst" -log simulate.log
}
