...
#
# Script generated by Vivado on Wed Mar 06 13:34:06 CET 2024
...
simulate()
{
  xsim design_1 -key {Behavioral:sim_1:Functional:design_1} -tclbatch cmd.tcl -protoinst "protoinst_files/clock.protoinst" -protoinst "protoinst_files/multiplexer_4_1.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
