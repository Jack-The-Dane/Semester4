...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.multiplexer_4_1 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.multiplexer_4_1 -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/jacob/Documents/Semester4/FPGA/Vivado/Lab1/Lab1.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log multiplexer_4_1_sc.so .tmp_log xcelium_lib waves.shm c.obj)
