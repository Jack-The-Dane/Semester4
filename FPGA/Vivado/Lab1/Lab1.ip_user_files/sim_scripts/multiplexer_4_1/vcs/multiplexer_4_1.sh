...
#
# Script generated by Vivado on Wed Feb 21 15:27:46 CET 2024
# SW Build 4029153 on Fri Oct 13 20:13:54 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : multiplexer_4_1.sh
...
#
# Usage        : multiplexer_4_1.sh
#                multiplexer_4_1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                multiplexer_4_1.sh [-reset_run]
#                multiplexer_4_1.sh [-reset_log]
#                multiplexer_4_1.sh [-help]
#
...
#                script (type 'multiplexer_4_1.sh -help' for more information).
#
...
# script info
echo -e "multiplexer_4_1.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./multiplexer_4_1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.multiplexer_4_1 xil_defaultlib.glbl -o multiplexer_4_1_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./multiplexer_4_1_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/jacob/Documents/Semester4/FPGA/Vivado/Lab1/Lab1.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key multiplexer_4_1_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc multiplexer_4_1_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./multiplexer_4_1.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: multiplexer_4_1.sh [-help]\n\
Usage: multiplexer_4_1.sh [-step]\n\
Usage: multiplexer_4_1.sh [-lib_map_path]\n\
Usage: multiplexer_4_1.sh [-reset_run]\n\
Usage: multiplexer_4_1.sh [-reset_log]\n\
Usage: multiplexer_4_1.sh [-keep_index]\n\
Usage: multiplexer_4_1.sh [-noclean_files]\n\n\
