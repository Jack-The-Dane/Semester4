...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot multiplexer_4_1 xil_defaultlib.multiplexer_4_1 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim multiplexer_4_1 -key {Behavioral:sim_1:Functional:multiplexer_4_1} -tclbatch cmd.tcl -protoinst "protoinst_files/multiplexer_4_1.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb multiplexer_4_1.wdb xsim.dir libdpi.so)
