...
design_libs_elab="-libname xlconcat_v2_1_5 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xlconcat_v2_1_5 xil_defaultlib)
