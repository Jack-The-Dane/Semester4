...
#
# Script generated by Vivado on Wed Apr 03 15:42:05 CEST 2024
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xlconcat_v2_1_5 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot full_adder xil_defaultlib.full_adder xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim full_adder -key {Behavioral:sim_1:Functional:full_adder} -tclbatch cmd.tcl -protoinst "protoinst_files/full_adder.protoinst" -protoinst "protoinst_files/half_adder.protoinst" -log simulate.log
}
