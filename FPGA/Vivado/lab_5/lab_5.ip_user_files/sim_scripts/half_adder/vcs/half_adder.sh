...
design_libs=(xil_defaultlib xlconcat_v2_1_5)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.half_adder xil_defaultlib.glbl -o half_adder_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./half_adder_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key half_adder_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc half_adder_simv.daidir vcs_lib c.obj)
