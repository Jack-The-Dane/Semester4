...
#
# Script generated by Vivado on Wed Apr 03 15:28:27 CEST 2024
# SW Build 4029153 on Fri Oct 13 20:13:54 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : half_adder.sh
...
#
# Usage        : half_adder.sh
#                half_adder.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                half_adder.sh [-reset_run]
#                half_adder.sh [-reset_log]
#                half_adder.sh [-help]
#
...
#                script (type 'half_adder.sh -help' for more information).
#
...
design_libs_elab="-libname xil_defaultlib -libname xlconcat_v2_1_5 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xil_defaultlib xlconcat_v2_1_5)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "half_adder.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./half_adder.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.half_adder xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.half_adder -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log half_adder_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./half_adder.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: half_adder.sh [-help]\n\
Usage: half_adder.sh [-step]\n\
Usage: half_adder.sh [-lib_map_path]\n\
Usage: half_adder.sh [-reset_run]\n\
Usage: half_adder.sh [-reset_log]\n\
Usage: half_adder.sh [-keep_index]\n\
Usage: half_adder.sh [-noclean_files]\n\n\
