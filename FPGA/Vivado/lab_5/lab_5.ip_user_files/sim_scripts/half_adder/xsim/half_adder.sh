...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xlconcat_v2_1_5 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot half_adder xil_defaultlib.half_adder xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim half_adder -key {Behavioral:sim_1:Functional:half_adder} -tclbatch cmd.tcl -protoinst "protoinst_files/half_adder.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb half_adder.wdb xsim.dir libdpi.so)
