...
#
# Script generated by Vivado on Wed Apr 03 17:36:41 CEST 2024
# SW Build 4029153 on Fri Oct 13 20:13:54 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : div_test.sh
...
#
# Usage        : div_test.sh
#                div_test.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                div_test.sh [-reset_run]
#                div_test.sh [-reset_log]
#                div_test.sh [-help]
#
...
# script info
echo -e "div_test.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./div_test.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot div_test xil_defaultlib.div_test xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim div_test -key {Behavioral:sim_1:Functional:div_test} -tclbatch cmd.tcl -protoinst "protoinst_files/div_test.protoinst" -protoinst "protoinst_files/full_adder.protoinst" -protoinst "protoinst_files/half_adder.protoinst" -protoinst "protoinst_files/subtractor_4_bit.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb div_test.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./div_test.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: div_test.sh [-help]\n\
Usage: div_test.sh [-step]\n\
Usage: div_test.sh [-lib_map_path]\n\
Usage: div_test.sh [-reset_run]\n\
Usage: div_test.sh [-reset_log]\n\
Usage: div_test.sh [-keep_index]\n\
Usage: div_test.sh [-noclean_files]\n\n\
