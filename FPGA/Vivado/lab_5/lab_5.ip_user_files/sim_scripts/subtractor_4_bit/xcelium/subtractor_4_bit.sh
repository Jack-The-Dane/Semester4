...
#
# Script generated by Vivado on Wed Apr 03 17:09:09 CEST 2024
# SW Build 4029153 on Fri Oct 13 20:13:54 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : subtractor_4_bit.sh
...
#
# Usage        : subtractor_4_bit.sh
#                subtractor_4_bit.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                subtractor_4_bit.sh [-reset_run]
#                subtractor_4_bit.sh [-reset_log]
#                subtractor_4_bit.sh [-help]
#
...
#                script (type 'subtractor_4_bit.sh -help' for more information).
#
...
design_libs_elab="-libname xil_defaultlib -libname xlconcat_v2_1_5 -libname xlconstant_v1_1_8 -libname xlslice_v1_0_3 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xil_defaultlib xlconcat_v2_1_5 xlconstant_v1_1_8 xlslice_v1_0_3)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "subtractor_4_bit.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./subtractor_4_bit.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.subtractor_4_bit xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.subtractor_4_bit -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/jacob/Documents/Semester4/FPGA/Vivado/lab_5/lab_5.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log subtractor_4_bit_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./subtractor_4_bit.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: subtractor_4_bit.sh [-help]\n\
Usage: subtractor_4_bit.sh [-step]\n\
Usage: subtractor_4_bit.sh [-lib_map_path]\n\
Usage: subtractor_4_bit.sh [-reset_run]\n\
Usage: subtractor_4_bit.sh [-reset_log]\n\
Usage: subtractor_4_bit.sh [-keep_index]\n\
Usage: subtractor_4_bit.sh [-noclean_files]\n\n\
