...
design_libs=(xil_defaultlib xlconcat_v2_1_5 xlconstant_v1_1_8 xlslice_v1_0_3)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.subtractor_4_bit xil_defaultlib.glbl -o subtractor_4_bit_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./subtractor_4_bit_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/jacob/Documents/Semester4/FPGA/Vivado/lab_5/lab_5.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key subtractor_4_bit_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc subtractor_4_bit_simv.daidir vcs_lib c.obj)
