...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xlconcat_v2_1_5 -L xlconstant_v1_1_8 -L xlslice_v1_0_3 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot subtractor_4_bit xil_defaultlib.subtractor_4_bit xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim subtractor_4_bit -key {Behavioral:sim_1:Functional:subtractor_4_bit} -tclbatch cmd.tcl -protoinst "protoinst_files/full_adder.protoinst" -protoinst "protoinst_files/half_adder.protoinst" -protoinst "protoinst_files/subtractor_4_bit.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb subtractor_4_bit.wdb xsim.dir libdpi.so)
